...
#include "accounts/setup/resource.h"
#include "accounts/setup/transport.h"
    ...
    , m_smtpAuthenticationType{AuthenticationType::Plain}
{
    ...
    connect(m_setupManager, &SetupManager::setupInfo, this, [this](const QString &msg){ Q_EMIT setupInfo(msg); });
}
